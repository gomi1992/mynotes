...
clipped_at: 2023-02-15 20:26:04
category: default
tags: 
 - 无
---
...
![Linus Torvalds](assets/1676463964-419e15f4ddf4a5ed6731d6f80de75ca1.jpg)
...
学习 Git 的内部实现，最好的办法是看 Linus 最初的代码提交，checkout 出 git 项目的第一次提交节点（方法参见博客：[《阅读开源代码小技巧》](https://hutusi.com/git-paging)），可以看到代码库中只有几个文件：一个 README，一个构建脚本Makefile，剩下几个 C 源文件。这次 commit 的备注写的也非常特别： Initial revision of “git”, the information manager from hell.
...
![Git simple objects model](assets/1676463964-283fe4daa4cfe88fdedae210b359fe24.png)
...
![Git Working tree, staging area, and Git directory.](assets/1676463964-0eea1234c5bbb19454838f79efa0cdf3.png)
...
1.  _Pro Git, 10.2 Git Internals - Git Objects_: https://git-scm.com/book/en/v2/Git-Internals-Git-Objects [↩](#fnref:1)
    
2.  _Things About Git and Github You Need to Know as Developer_: https://medium.com/swlh/things-about-git-and-github-you-need-to-know-as-developer-907baa0bed79 [↩](#fnref:2)
    
3.  本文最早写作完成于2020年9月8日，并于9月9日发表于公司内网 Hi3ms 社区和心声社区，为了给 CodeConf 大会做广告宣传用(转发到外网时去除了文末广告)。 [↩](#fnref:3)