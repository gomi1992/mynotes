...
*   [Serverless 架构](#serverless-%E6%9E%B6%E6%9E%84)
    ...
    *   [Serverless 的问题](#serverless-%E7%9A%84%E9%97%AE%E9%A2%98)
...
*   [基于 Kinesis Streams 的数据流分析](#%E5%9F%BA%E4%BA%8E-kinesis-streams-%E7%9A%84%E6%95%B0%E6%8D%AE%E6%B5%81%E5%88%86%E6%9E%90)
    ...
    *   [Serverless + Kinesis Streams](#serverless-kinesis-streams)
...
*   [使用 Simulate 插件在本地运行 Lambda](#%E4%BD%BF%E7%94%A8-simulate-%E6%8F%92%E4%BB%B6%E5%9C%A8%E6%9C%AC%E5%9C%B0%E8%BF%90%E8%A1%8C-lambda)
...
![微信](assets/1676698826-53452ffc43ca46d07f40714f569b8d0c.jpg)
...
![Firehose](assets/1676698826-9bd5f668315bd044978fed59186a0f7c.png)
...
![Launch Page](assets/1676698826-e92c30e546567b38fe0204a90cf90917.jpg)
...
![PostMan 示例](assets/1676698826-316e5c502cccd39b972576378a84f5f6.png)
...
![Auth GitHub](assets/1676698826-9310cda5995f72cd7a303999670c6464.png)
...
![CORS 配置](assets/1676698826-14f31ec09cd45f9c6e0c0b5167192c8e.png)

CORS 配置

然后，再测试一下登录：

![Auth0 测试登录](assets/1676698826-4f02c88d686268939820506a86f06bc9.png)
...
这次我们将基于之前的文章《[Serverless 应用开发指南：Lambda + API Gateway + DynamoDB 制作 REST API](https://www.phodal.com/blog/serverless-developement-gui-lambda-api-gateway-dynamodb-create-restful-services/)》中的 todolist，来开始我们的调试之旅。
...
![PostMan 测试 Serverless Offline](assets/1676698826-8e761595d5a95f1254a57ac3a4adec30.png)
...
![Serverless 控制台](assets/1676698826-fb2faa8c127ea4516fbf015ec38e9d0f.png)

Serverless 控制台

然后打开 AWS IoT 控制台，进入『测试』，即 MQTT 客户端页面：

![AWS IoT MQTT 测试页面](assets/1676698826-f04a9f244ddccc620f6a0d2c352d47e7.png)
...
![AWS IoT 发布主题](assets/1676698826-f04a9f244ddccc620f6a0d2c352d47e7.png)
...
> WarmUP: runs 8640 times per month = $0.18 10 warm lambdas: each invoked 8640 times per month = $14.4 Total = $14.58
...
![系统架构图](assets/1676698826-91b6cc88ede96683ebca6263128adab5.png)
...
![MoPass C4 Context](assets/1676698826-38b7a7cfcada7de102e1195fcba0f66f.jpg)

MoPass C4 Context

系统的组件和关系相对都比较简单：

![MoPass C4 Container](assets/1676698826-ad508a0d23f008c77317be164b65d278.jpg)
...
![OpenWhisk 流处理流程](assets/1676698826-5131fdf00030d6b605434d0234622cc7.png)
...
![OpenWhisk 组件](assets/1676698826-c7f2631c952106779d4570b3acba5828.png)
...
1.  选自《全栈应用开发：精益实践》的『隔离与运行环境』一节[↩](#fnref1)
    
2.  https://aws.amazon.com/cn/blogs/china/iaas-faas-serverless/[↩](#fnref2)
    
3.  https://zh.wikipedia.org/wiki/%E4%BA%8B%E4%BB%B6%E9%A9%85%E5%8B%95%E7%A8%8B%E5%BC%8F%E8%A8%AD%E8%A8%88[↩](#fnref3)